...
class RobustOpenAIController(RobustBaseLLMController):
    def __init__(self, model: str = "gpt-4", api_key: Optional[str] = None, base_url: Optional[str] = None):
        ...
        # Support custom base_url for DeepSeek, Azure, etc.
        if base_url:
...
class RobustLLMController:
    ...
    def __init__(self,
                 backend: Literal["openai", "ollama", "sglang", "vllm", "deepseek"] = "sglang",
                 model: str = "gpt-4",
                 api_key: Optional[str] = None,
        ...
        if backend == "openai":
            ...
            raise ValueError("Backend must be 'openai', 'deepseek', 'ollama', 'sglang', or 'vllm'")
